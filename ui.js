...
if(header)header.innerHTML=`<header class="site-head"><div class="edition-line"><div class="wrap"><span>让 AI 成为你的生意优势</span><span><a href="brand.html">关于艾瑞斯</a>　 /　 <a href="lab.html">我的学习</a>${window.AIRIS_PUBLIC_SNAPSHOT?'':'　 /　 <a href="admin.html">内容管理</a>'}</span></div></div><div class="wrap head-inner"><a class="wordmark" href="index.html" aria-label="艾瑞斯首页">${brandMarkup}</a><div class="brand-descriptor"><strong>AI 电商产业门户</strong>看懂变化，陪你一起成长</div><form class="header-search" role="search" action="intelligence.html"><label class="sr-only" for="header-query">搜索本站文章</label><input id="header-query" name="q" type="search" placeholder="搜索 AI、跨境、接待、培训…" maxlength="100"><button type="submit">搜索</button></form><a class="btn btn-primary head-cta" href="partner.html">和 AI 业务合伙人聊聊</a><button class="menu-toggle" aria-label="打开导航" aria-expanded="false" aria-controls="site-nav">☰</button></div><div class="nav-row"><div class="wrap nav-wrap"><nav class="site-nav" id="site-nav" aria-label="主导航"><a href="index.html">首页</a><a href="intelligence.html">行业情报</a><a href="international.html">国际站专区</a><a href="toolkit.html">AI 工具</a><a href="academy.html">商学院</a><a href="events.html">活动与直播</a><a href="sources.html">信息源导航</a><a href="enterprise.html">企业合作</a></nav><a class="nav-utility" href="enterprise.html#panel-2">专家 / 机构合作</a></div></div></header>`;
const footer=document.querySelector('[data-footer]');
if(footer)footer.innerHTML=`<footer class="site-footer"><div class="wrap"><div class="footer-grid"><a class="wordmark" href="index.html" aria-label="艾瑞斯首页">${brandMarkup}</a><div class="footer-links"><a href="intelligence.html">行业情报</a><a href="international.html">国际站专区</a><a href="toolkit.html">AI 工具</a><a href="academy.html">商学院</a><a href="events.html">活动与直播</a><a href="sources.html">信息源导航</a><a href="enterprise.html">企业合作</a><a href="lab.html">我的学习</a><a href="brand.html">品牌与 VI</a>${window.AIRIS_PUBLIC_SNAPSHOT?'':'<a href="admin.html">内容管理</a>'}</div></div><div class="footer-bottom"><span>© AIRIS 艾瑞斯 · AI 电商产业门户</span><span>和认真做生意的人，一起成长</span></div></div></footer>`;
